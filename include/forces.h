...
/**
 * Defines a type for a force entry structure.
 */
typedef struct force_entry {
...
/**
 * Defines a type for a body aux structure.
 */
 ...
 * between the ramp and ball. One of the bodies should be the ramp.
 *
 * @param scene the scene containing the bodies
 * @param body1 the first body
 * @param body2 the second body
 * @param slope coefficient representing the ramp's slope, can be negative
 */
 ...
 * function each time two bodies collide. One of the bodies should be the ramp.
 *
 * @param scene the scene containing the bodies
 * @param body1 the first body
 * @param body2 the second body
 * @param handler should be the ramp handler
...
/**
 * The ramp collision handler. Applies impulses to
 * bodies according to the force_const.
 * 
 * @param body1 the first body
 * @param body2 the second body
 * @param axis of collision
 * @param aux an auxiliary value to pass to the handler
 * @param force_const a constant to pass to the handler
 */
...
/**
 * Initializes a force entry with a specified force creator function and
 * auxiliary data.
 *
 * @param force_creator The function pointer to the force creator function that
 * applies forces.
 * @param aux Pointer to auxiliary data needed by the force creator.
 * @param bodies List of bodies acted on by force
 * @return Pointer to the newly created force entry structure.
 */
force_entry_t *force_entry_init(force_creator_t force_creator, void *aux,
                                list_t *bodies);

/**
 * Releases the memory allocated for a force entry.
 *
 * @param entry The force entry to be freed.
 */

void force_free(force_entry_t *entry);

/**
 * Retrieves the aux data associated with a force entry.
 *
 * @param entry Pointer to the force entry from which the aux data is retrieved.
 * @return Pointer to the aux data.
 */
void *forces_get_force_aux(force_entry_t *entry);

/**
 * Retrieves the force creator function associated with a force entry.
 *
 * @param entry Pointer to the force entry.
 * @return The function pointer to the force creator.
 */
